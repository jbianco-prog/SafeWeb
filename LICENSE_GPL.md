...
- ❌ **No liability** - Authors are not liable for damages, including alerts, incidents or service disruptions caused by running security tests
- ❌ **No trademark rights** - Does not grant trademark permissions (EICAR, Google, WICAR and proxy vendor names belong to their respective owners)
...
### Source Code
"Source code" means the preferred form of the work for making modifications to it. This includes all scripts, configuration files, and instructions necessary to run the software.
...
**Yes!** GPL v3 allows commercial use. You can use this software in your business, in security audits for customers, charge for support, or include it in commercial offerings. However, if you distribute it (modified or not), you must provide the source code under GPL v3.

### Can I modify the code for internal use?
**Yes!** You can modify the code for internal use (custom URLs, block-page keywords, SMTP settings…) without distributing the changes. The GPL only requires you to share modifications if you distribute the software to others.
...
**No.** As a user, you cannot relicense GPL software. Only the copyright holders can change the license. However, you can dual-license your own original contributions if you are the sole author.

### Am I allowed to run these tests against any network?
**No.** The license covers the code, not the right to test. Only run SafeWeb on networks and proxies you own or are explicitly authorized to test.
